...
const securityHeaders = [
  ...
  // Allow IutePay SDK to load scripts and open iframes
  {
    ...
    value: [
      ...
      "frame-src 'self' https://ecom.iutecredit.md https://iutecredit.md https://iute.md https://www.google.com https://maps.google.com https://www.openstreetmap.org https://www.google.com/maps",
