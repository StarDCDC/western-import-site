...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Header */}
      <header
        className={`sticky top-1 z-[100] bg-slate-800/95 backdrop-blur-xl transition-all duration-300 rounded-2xl mx-2 sm:mx-4 lg:mx-6 shadow-sm dark:bg-slate-900/95 ${
          scrolled ? 'shadow-lg' : ''
