            ...
            return (
              ...
              >
                <Link
                  ...
                  className="flex flex-col items-center gap-3 w-[170px] bg-white dark:bg-[var(--color-dark-elevated)] rounded-2xl p-5 border border-black/[0.04] dark:border-white/[0.06] hover:-translate-y-1 hover:shadow-md hover:border-primary/20 dark:hover:border-primary/30 transition-all duration-300"
                >
