              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Aduceți produsul la sediul nostru din str. Ștefan cel Mare 1, Chișinău, sau programați ridicarea prin curier (gratuit în garanție).",
                  },
                  {
                    step: 4,
              ...
              <div className="p-5 bg-slate-50 dark:bg-slate-800 rounded-xl">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-600 dark:text-slate-400 text-sm">
                  ...
                  <div>
                    ...
                    <p>str. Ștefan cel Mare 1, Chișinău</p>
                  </div>
                  <div>
