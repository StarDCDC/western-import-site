          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
              <div className="p-5 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">150 MDL · Gratuit peste 3000 MDL</p>
              ...
              <div className="p-5 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">200 MDL</p>
              ...
              <div className="p-5 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">str. Ștefan cel Mare 1, Chișinău</p>
              </div>
            </div>
                ...
                <table className="w-full text-sm border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                  ...
                  <tbody className="text-slate-600 dark:text-slate-400">
                    <tr className="border-t border-slate-200 dark:border-slate-700">
                      ...
                      <td className="py-3 px-4">150 MDL <span className="text-xs text-green-600 dark:text-green-400">(gratuit ≥3000 MDL)</span></td>
                    ...
                    <tr className="border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                      ...
                      <td className="py-3 px-4">200 MDL</td>
            ...
            <section className="mb-10">
              ...
              <ul className="list-disc list-inside space-y-2 text-slate-600 dark:text-slate-400">
                ...
                <li>Pentru comenzile peste 3000 MDL, livrarea în Chișinău este <strong>gratuită</strong>.</li>
