          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6">
              <div className="space-y-6">
                {/* Customer Info */}
                <div className="bg-white dark:bg-[var(--color-dark-elevated)] rounded-2xl p-5 border border-black/[0.04] dark:border-white/[0.06]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div data-error={errors.customerName ? 'true' : undefined}>
                      ...
                      <input
                        ...
                        className={`w-full py-2.5 px-3 rounded-lg border ${errors.customerName ? 'border-red-400 bg-red-50 dark:bg-red-950/20' : 'border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)]'} text-sm`}
                    ...
                    <div data-error={errors.phone ? 'true' : undefined}>
                      ...
                      <input
                        ...
                        className={`w-full py-2.5 px-3 rounded-lg border ${errors.phone ? 'border-red-400 bg-red-50 dark:bg-red-950/20' : 'border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)]'} text-sm`}
                    ...
                    <div data-error={errors.email ? 'true' : undefined}>
                      ...
                      <input
                        ...
                        className={`w-full py-2.5 px-3 rounded-lg border ${errors.email ? 'border-red-400 bg-red-50 dark:bg-red-950/20' : 'border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)]'} text-sm`}
                        ...
                        <button
                          ...
                          className={`p-4 rounded-xl border-2 text-left transition-colors ${
                            form.deliveryMethod === m.id
                              ...
                              : 'border-black/[0.08] dark:border-white/[0.08] hover:border-primary/30 dark:hover:border-primary/30'
                          }`}
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div data-error={errors.city ? 'true' : undefined}>
                        ...
                        <select
                          ...
                          className="w-full py-2.5 px-3 rounded-lg border border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)] text-sm"
                        >
                      ...
                      <div data-error={errors.raion ? 'true' : undefined}>
                        ...
                        <input
                          ...
                          className={`w-full py-2.5 px-3 rounded-lg border ${errors.raion ? 'border-red-400 bg-red-50 dark:bg-red-950/20' : 'border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)]'} text-sm`}
                      ...
                      <div data-error={errors.strada ? 'true' : undefined}>
                        ...
                        <input
                          ...
                          className={`w-full py-2.5 px-3 rounded-lg border ${errors.strada ? 'border-red-400 bg-red-50 dark:bg-red-950/20' : 'border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)]'} text-sm`}
                      ...
                      <div data-error={errors.codPostal ? 'true' : undefined}>
                        ...
                        <input
                          ...
                          className={`w-full py-2.5 px-3 rounded-lg border ${errors.codPostal ? 'border-red-400 bg-red-50 dark:bg-red-950/20' : 'border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)]'} text-sm`}
                ...
                <div className="bg-white dark:bg-[var(--color-dark-elevated)] rounded-2xl p-5 border border-black/[0.04] dark:border-white/[0.06]">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full py-2.5 px-3 rounded-lg border border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)] text-sm resize-none"
              ...
              {/* Summary Sidebar */}
              <div>
                <div className="bg-white dark:bg-[var(--color-dark-elevated)] rounded-2xl p-5 border border-black/[0.04] dark:border-white/[0.06] sticky top-24">
                  ...
                  <div className="border-t border-slate-100 dark:border-white/[0.06] pt-3 space-y-2 text-sm">
                    ...
                    <div className="border-t border-slate-100 dark:border-white/[0.06] pt-2 flex justify-between font-bold text-lg text-slate-800 dark:text-white">
                      <span>{txt.total}</span>
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          ...
                          <input
                            ...
                            className="w-full py-2 pl-9 pr-3 rounded-lg border border-black/[0.08] bg-slate-50 dark:bg-[var(--color-dark-elevated)] text-sm"
                          />
                        </div>
                        <button
                          type="button"
