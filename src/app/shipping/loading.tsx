  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[var(--color-dark-bg)]">
      <div className="max-w-4xl mx-auto px-4 py-8 animate-pulse">
        <div className="h-8 bg-slate-200 dark:bg-[var(--color-dark-elevated)] rounded w-32 mb-4" />
        <div className="h-1 bg-slate-200 dark:bg-[var(--color-dark-elevated)] rounded w-16 mb-8" />
        <div className="grid grid-cols-3 gap-4 mb-8">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="h-32 bg-slate-200 dark:bg-[var(--color-dark-elevated)] rounded-xl" />
          ))}
        </div>
