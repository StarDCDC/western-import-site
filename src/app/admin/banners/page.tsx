...
export default function AdminBannersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add form */}
      {adding && (
        <div className="bg-white dark:bg-[var(--color-dark-elevated)] rounded-xl shadow-sm border border-amber-300 dark:border-amber-600 p-6 space-y-4">
          <h3 className="font-medium text-slate-900 dark:text-white">Banner nou</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">🇷🇴 Titlu *</label><input value={form.title} onChange={(e) => set("title", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">🇷🇺 Titlu (RU)</label><input value={form.titleRu} onChange={(e) => set("titleRu", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" placeholder="Titlu în rusă" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">🇷🇴 Subtitlu</label><input value={form.subtitle} onChange={(e) => set("subtitle", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">🇷🇺 Subtitlu (RU)</label><input value={form.subtitleRu} onChange={(e) => set("subtitleRu", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" placeholder="Subtitlu în rusă" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Imagine (URL sau încarcă) *</label><div className="flex gap-2"><input value={form.image} onChange={(e) => set("image", e.target.value)} className="flex-1 px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" placeholder="https://... sau lasă gol și folosește butonul" /><label className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm font-medium cursor-pointer flex items-center gap-1"><input type="file" accept="image/*" className="hidden" onChange={(e) => handleImageUpload(e, (v) => set("image", v))} />Încarcă</label></div>{form.image && <img src={form.image} alt="preview" className="mt-2 h-20 rounded-lg object-cover" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />}</div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Imagine RU (URL sau încarcă)</label><div className="flex gap-2"><input value={form.imageRu} onChange={(e) => set("imageRu", e.target.value)} className="flex-1 px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" placeholder="https://... imagine pentru versiunea RU" /><label className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-sm font-medium cursor-pointer flex items-center gap-1"><input type="file" accept="image/*" className="hidden" onChange={(e) => handleImageUpload(e, (v) => set("imageRu", v))} />Încarcă</label></div>{form.imageRu && <img src={form.imageRu} alt="preview RU" className="mt-2 h-20 rounded-lg object-cover" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />}</div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Link</label><input value={form.link} onChange={(e) => set("link", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">🇷🇴 Buton CTA</label><input value={form.buttonText} onChange={(e) => set("buttonText", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">🇷🇺 Buton CTA (RU)</label><input value={form.buttonTextRu} onChange={(e) => set("buttonTextRu", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" placeholder="Текст кнопки" /></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Poziție</label><select value={form.position} onChange={(e) => set("position", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none"><option value="HERO">Hero</option><option value="MIDDLE">Middle</option><option value="SIDEBAR">Sidebar</option><option value="FOOTER">Footer</option></select></div>
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Ordine</label><input type="number" value={form.order} onChange={(e) => set("order", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /></div>
            ...
            <div><label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Dată sfârșit</label><input type="datetime-local" value={form.endDate} onChange={(e) => set("endDate", e.target.value)} className="w-full px-3 py-2 border border-slate-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-amber-500 outline-none" /></div>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => { setAdding(false); resetForm(); }} className="px-4 py-2 border border-slate-300 dark:border-white/[0.08] text-slate-600 dark:text-slate-300 rounded-lg text-sm">Anulează</button>
          </div>
        </div>
      )}
      ...
      <div className="space-y-4">
        ...
        {banners.map((b) => {
          ...
          return (
            <div key={b.id} className={`bg-white dark:bg-[var(--color-dark-elevated)] rounded-xl shadow-sm border overflow-hidden ${b.isActive ? "border-slate-200 dark:border-white/[0.06]" : "border-slate-200 dark:border-white/[0.06] opacity-60"}`}>
              {isEditing ? (
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => { setEditing(null); resetForm(); }} className="px-4 py-2 border border-slate-300 dark:border-white/[0.08] text-slate-600 dark:text-slate-300 rounded-lg text-sm">Anulează</button>
                  </div>
                </div>
              ) : (
                <div className="p-5">
